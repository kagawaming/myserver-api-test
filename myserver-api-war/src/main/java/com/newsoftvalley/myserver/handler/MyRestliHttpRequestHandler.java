 ...
 */
package com.newsoftvalley.myserver.handler;
 ...
 * @author jpbetz
 */
public class MyRestliHttpRequestHandler implements HttpRequestHandler {

  private RAPServlet _r2Servlet;


  public MyRestliHttpRequestHandler(RestLiConfig config,
      SpringInjectResourceFactory injectResourceFactory,
      FilterChain filterChain,
      Engine engine)
  {
    RestLiServer restLiServer = new RestLiServer(config, injectResourceFactory, engine);
